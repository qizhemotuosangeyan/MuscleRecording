...
struct PlayBodyView: View {
    ...
    @ViewBuilder func overlayLines(_ geometry: GeometryProxy) -> some View {
        ...
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Deltoids, subPart: BodyPart.DeltoidPart.Acromion.rawValue, value: data.measurements[.Deltoids]?[BodyPart.DeltoidPart.Acromion.rawValue]?.value ?? 0
        )
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Deltoids, subPart: BodyPart.DeltoidPart.Deltoid.rawValue, value: data.measurements[.Deltoids]?[BodyPart.DeltoidPart.Deltoid.rawValue]?.value ?? 0
        )
        ...
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Chest, subPart: BodyPart.ChestPart.Pectoral.rawValue, value: data.measurements[.Chest]?[BodyPart.ChestPart.Pectoral.rawValue]?.value ?? 0
        )
        ...
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Arms, subPart: BodyPart.ArmPart.BicepsTrough.rawValue, value: data.measurements[.Arms]?[BodyPart.ArmPart.BicepsTrough.rawValue]?.value ?? 0
        )
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Arms, subPart: BodyPart.ArmPart.BicepsPeak.rawValue, value: data.measurements[.Arms]?[BodyPart.ArmPart.BicepsPeak.rawValue]?.value ?? 0
        )
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Arms, subPart: BodyPart.ArmPart.LowerArm.rawValue, value: data.measurements[.Arms]?[BodyPart.ArmPart.LowerArm.rawValue]?.value ?? 0
        )
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Arms, subPart: BodyPart.ArmPart.Wrist.rawValue, value: data.measurements[.Arms]?[BodyPart.ArmPart.Wrist.rawValue]?.value ?? 0
        )
        ...
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Core, subPart: BodyPart.CorePart.UpperWaist.rawValue, value: data.measurements[.Core]?[BodyPart.CorePart.UpperWaist.rawValue]?.value ?? 0
        )
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Core, subPart: BodyPart.CorePart.LowerWaist.rawValue, value: data.measurements[.Core]?[BodyPart.CorePart.LowerWaist.rawValue]?.value ?? 0
        )
        ...
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Thighs, subPart: BodyPart.ThighsPart.ThighMusclePeak.rawValue, value: data.measurements[.Thighs]?[BodyPart.ThighsPart.ThighMusclePeak.rawValue]?.value ?? 0
        )
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Thighs, subPart: BodyPart.ThighsPart.Length.rawValue, value: data.measurements[.Thighs]?[BodyPart.ThighsPart.Length.rawValue]?.value ?? 0
        )
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Thighs, subPart: BodyPart.ThighsPart.Knee.rawValue, value: data.measurements[.Thighs]?[BodyPart.ThighsPart.Knee.rawValue]?.value ?? 0
        )
        ...
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Calves, subPart: BodyPart.CalfPart.CalfMusclePeak.rawValue, value: data.measurements[.Calves]?[BodyPart.CalfPart.CalfMusclePeak.rawValue]?.value ?? 0
        )
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Calves, subPart: BodyPart.CalfPart.Length.rawValue, value: data.measurements[.Calves]?[BodyPart.CalfPart.Length.rawValue]?.value ?? 0
        )
        LineWithPreviewAnnotation(
            ...
            bodyPart: .Calves, subPart: BodyPart.CalfPart.Ankle.rawValue, value: data.measurements[.Calves]?[BodyPart.CalfPart.Ankle.rawValue]?.value ?? 0
        )
    }
